/* Same license as Node.js
	...
	I removed the external haxelib dependencies until the haxe ports are maintained
	properly without having to fear about breaking things after yet another update.
	
	Copied from Dion Amago's (dion@transition9.com) repo that was in turn copied from
	Ritchie Turner's (blackdog@cloudshift.cl) repo due to slow updates.
*/
